...
CEmentaDisciplina::~CEmentaDisciplina(){ SalvarEstado(); };
...
void CEmentaDisciplina::DefinirPreRequisito()
{
...
void CEmentaDisciplina::DefinirAssuntos(){
  int i{1};
  CAssunto assunto_i;
  std::string sAssunto;
...
void CEmentaDisciplina::SalvarEstado(std::string identificadorEstado )
{
...
void CEmentaDisciplina::RecuperarEstado(std::string identificadorEstado )
{
...
std::ostream& operator<<(std::ostream& arquivo, CEmentaDisciplina& ementa) {
