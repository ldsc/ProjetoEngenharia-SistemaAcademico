...
int main() {
  ...
  for(int i=0; i<10; i++) {
    ...
    CCodigoDisciplina CodigoDisciplina = geradorCodigoDisciplina(sSiglaDepartamento); // sobrecarga operador()
    //sCodigoDisciplina = geradorCodigoDisciplina.DefinirCodigo(siglaDepartamento);
